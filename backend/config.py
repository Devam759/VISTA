...
class Config:
    ...
    HOSTEL_LATITUDE = float(os.getenv('HOSTEL_LATITUDE', 26.2389))  # REPLACE WITH YOUR LATITUDE
    HOSTEL_LONGITUDE = float(os.getenv('HOSTEL_LONGITUDE', 73.0243))  # REPLACE WITH YOUR LONGITUDE
    GPS_ACCURACY_RADIUS = int(os.getenv('GPS_ACCURACY_RADIUS', 100))  # RADIUS IN METERS
